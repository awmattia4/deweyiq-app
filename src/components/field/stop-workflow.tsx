    ...
    <>
      <div className="flex flex-col min-h-[calc(100dvh-4rem)]">
        ...
        <Tabs defaultValue="chemistry" className="flex flex-col flex-1">
          ...
          <TabsList className="w-full! grid! grid-cols-4! rounded-none! border-b! border-border/60! bg-transparent! h-auto! p-0! gap-0! shrink-0!">
            <TabsTrigger
              value="chemistry"
              className="h-auto! rounded-none! border-0! border-b-2! border-transparent! shadow-none! bg-transparent! dark:bg-transparent! min-h-[44px] py-2 text-xs data-[state=active]:text-foreground data-[state=active]:border-primary! cursor-pointer"
            >

...
export function CompletionModal({
  ...
  return (
    <Sheet open={open} onOpenChange={(v) => !v && onClose()}>
      <SheetContent
        side="bottom"
        className="rounded-t-2xl max-h-[90dvh] overflow-y-auto pb-safe"
      >
        ...
        <div className="flex flex-col gap-5 pt-5">
          ...
          <div className="flex flex-col gap-3">
            ...
            {enteredParams.length > 0 ? (
              <div className="grid grid-cols-2 gap-x-4 gap-y-1.5 rounded-xl bg-muted/20 border border-border/40 px-4 py-3">
            ...
            {/* CSI value */}
            {csiResult && (
              <div className="flex items-center justify-between rounded-xl bg-muted/20 border border-border/40 px-4 py-2.5">
